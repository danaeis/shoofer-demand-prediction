...
```{python}
sort_locations_on_demand(predictions_dict, sorted_locations_dict)
print(sorted_locations_dict['model_regression'].shape)
sorted_locations_dict['model_regression'].head()
```
...
```{python}
print(predictions_mean_error_dict['model_regression']['Hour_interval']['high_demand_loc'].shape)
predictions_mean_error_dict['model_regression']['Hour_interval']['high_demand_loc'].tail()
```
