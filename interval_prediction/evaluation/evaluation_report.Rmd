...
```{python}
# predictions_dict['model_xgboost_ridge'] = pd.read_parquet(PREDICTED_SVR_RIDGE_PATH)
# print(predictions_dict['model_xgboost_ridge'].shape)
# predictions_dict['model_xgboost_ridge'].tail()
```
...
```{python}
# print(predictions_mean_error_dict['model_xgboost_ridge']['Hour_interval']['mid_demand_loc'].shape)
# predictions_mean_error_dict['model_xgboost_ridge']['Hour_interval']['mid_demand_loc'].tail()
```
