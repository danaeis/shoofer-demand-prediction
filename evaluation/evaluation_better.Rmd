...
def plot_mae(predictions_mean_dict, per):
    ...
    fig, axes = plt.subplots(nrows=(3 if (per == 'Location') else 2 ), ncols=1, figsize=((10,20)if (per == 'Location') else (10,15))) 
    ...
    axes[0].set_title('for '+str(IMPORTANT_LOCATIONS)+' imortant locations', bbox=dict( alpha=0.5)) 
    axes[1].set_title('other locations', bbox=dict(alpha=0.5)) 
