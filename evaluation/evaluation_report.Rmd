...
def create_table_errors(predictions_dict, report_dict):
    for model, error_df in predictions_dict.items():
        if error_df is not None:
            ...
            report_dict['all_locations']['MSE'][model] = error_df['squared_error'].mean()
            ...
            report_dict['important_lacations']['MSE'][model] = error_important_df['squared_error'].mean()
            ...
            report_dict['others_locations']['MSE'][model] = error_others_df['squared_error'].mean()
...
report_df.style \
  ...
  .relabel_index(["baseline_last_week", "model_regression", "model_xgboost"], axis=0)
```
