...
train_list = ['prev_month_demand', 'prev_2week_demand', 'prev_week_demand', 'prev_day_demand', 'month', 'day_month', 'day_week']
...
shap.summary_plot(shap_values, train_df[train_list])
```
