...
```{python}
# predictions_dict['model_svr_ridge'] = pd.read_parquet(PREDICTED_SVR_RIDGE_PATH)
# print(predictions_dict['model_svr_ridge'].shape)
# predictions_dict['model_svr_ridge'].tail()
```
...
```{python}
# print(predictions_dict['model_svr_ridge'].shape)
# predictions_dict['model_svr_ridge'].head()
```
...
```{python}
# print(predictions_mean_error_dict['model_svr_ridge']['Hour_interval']['mid_demand_loc'].shape)
# predictions_mean_error_dict['model_svr_ridge']['Hour_interval']['mid_demand_loc'].tail()
```
